function Hero() {
  return (
    <section className="h-screen flex flex-col justify-center items-center bg-gray-100 dark:bg-slate-950 text-center px-4">
      <img
        src="/yo.png"
      ...
      <p className="text-xl text-gray-700 dark:text-gray-100 mb-6 max-w-md" >
